      ...
      <div className="relative mx-auto mt-16 grid max-w-6xl grid-cols-1 gap-16 sm:grid-cols-2 lg:grid-cols-4">
        ...
        {STEPS.map((step) => (
          <div key={step.number} className="relative flex flex-col items-center text-center">
            <div className="relative mb-6 h-[270px] w-[130px] overflow-hidden rounded-[28px] border-4 border-[#2a2a35] bg-[#1a1a24] shadow-2xl">
              <Image src={step.image} alt={`${step.title} screen`} fill className="object-cover" />
            </div>
            <span className="absolute top-[254px] flex size-9 items-center justify-center rounded-full border-2 border-[#a855f7] bg-[#0b0b0f] text-xs font-bold text-[#a855f7] drop-shadow-[0_0_7px_rgba(168,85,247,0.5)]">
              {step.number}
            </span>
        ...
        <div className="relative flex flex-col items-center text-center">
          <div className="mb-6 flex h-[270px] w-[190px] flex-col items-center justify-center gap-4 rounded-[28px] border-4 border-[#2a2a35] bg-[#0b0b0f] p-4 shadow-2xl">
            <span
            ...
            <div className="flex w-full flex-col gap-2">
              <button className="w-full rounded-lg bg-white py-2 text-xs font-bold text-[#0b0b0f]">
                Shop on Website
              </button>
              <button className="w-full rounded-lg bg-white/10 py-2 text-xs font-bold text-white">
                View in Board
              </button>
            </div>
          </div>
          <span className="absolute top-[254px] flex size-9 items-center justify-center rounded-full border-2 border-[#a855f7] bg-[#0b0b0f] text-xs font-bold text-[#a855f7] drop-shadow-[0_0_7px_rgba(59,130,246,0.5)]">
            04
          </span>
