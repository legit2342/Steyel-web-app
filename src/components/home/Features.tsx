    ...
    tags: [
      {
        ...
        left: "52.6%",
        top: "3.1%",
        connector: { left: "47.6%", top: "8.7%", width: "5.1%", height: "4.7%" },
      },
      {
        label: "Jeans",
        left: "71.3%",
        top: "24.3%",
        connector: { left: "66.9%", top: "28.6%", width: "4.4%", height: "5.5%" },
      },
      {
        label: "Sunglasses",
        left: "1.8%",
        top: "47.7%",
        connector: { left: "14.3%", top: "53.8%", width: "7.2%", height: "4.9%" },
      },
      {
        label: "Hand bag",
        left: "65.3%",
        top: "63.7%",
        connector: { left: "60.1%", top: "69.2%", width: "5.2%", height: "5.2%" },
      },
      {
        label: "Sneakers",
        left: "2.6%",
        top: "74.6%",
        connector: { left: "16.8%", top: "80.7%", width: "5.3%", height: "4.5%" },
      },
    ],
  },
  {
